<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ALTERAR_FICHA.aspx.cs" Inherits="ALTERAR_FICHA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container-fluid">
        <fieldset>
            <legend id="Titulo" runat="server" style="font-weight: bold"><strong>Alterar Ficha</strong></legend>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grvData" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                class="table table-hover table-bordered" OnRowDeleting="OnRowDeleting" GridLines="None">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Obs">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtObs" runat="server" TextMode="MultiLine" Height="55px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
