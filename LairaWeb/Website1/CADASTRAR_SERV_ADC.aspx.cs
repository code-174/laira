...
public partial class CADASTRAR_SERV_ADC : System.Web.UI.Page
{
    ...
    protected void btnAdServ_Click(object sender, EventArgs e)
    {
        if (VerificarCampos())
        {
            try
            {
                ...
                str.AppendLine(" INSERT INTO [SERV_ADC] ");
                str.AppendLine(" ([COD_SERV_ADC] ");
                str.AppendLine(" ,[PASSEIO_SERV_ADC ] ");
                str.AppendLine(" ,[PRECO_SERV_ADC] ");
                str.AppendLine(" )");
                ...
                cmd.Parameters.Add(new SqlParameter("@B", SqlDbType.NChar)).Value = txtPasseio.Text.Trim();
