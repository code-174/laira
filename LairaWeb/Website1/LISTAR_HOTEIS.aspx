    ...
    <div class="container-fluid">
        <fieldset>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-inline">
                        <label class="sr-only" for="txtHotel">
                            Hotel:</label>
                        <asp:TextBox ID="txtHotel" runat="server" class="form-control" placeholder="Hotel"></asp:TextBox>
            ...
            <div class="btn-group btn-group-justified">
                <asp:LinkButton ID="lnkNew" runat="server" OnClick="lnkNew_Click" class="btn btn-primary">Adicionar Hotel</asp:LinkButton>
