<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="LISTAR_STATUS.aspx.cs" Inherits="LISTAR_STATUS" %>
    ...
    <div class="container-fluid">
        <fieldset>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-inline">
                        <label class="sr-only" for="txtStatus">
                            Status:</label>
            ...
            <div class="btn-group btn-group-justified">
                <asp:LinkButton ID="lnkNew" runat="server" OnClick="lnkNew_Click" class="btn btn-primary">Adicionar Status</asp:LinkButton>
